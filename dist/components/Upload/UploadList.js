...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "setsail-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "setsail-upload-list-item", key: item.uid },
            ...
            React.createElement("span", { className: "file-status" },
                item.status === "uploading" && React.createElement(Icon, { icon: "spinner", theme: "primary", spin: true }),

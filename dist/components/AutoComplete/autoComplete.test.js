...
var testProps = {
    fetchSuggestions: function (query) { return testArray.filter(function (item) { return item.value.includes(query); }); },
    onSelect: jest.fn(),
...
describe('test AutoComplete component', function () {
    beforeEach(function () {
        wrapper = render(React.createElement(AutoComplete, __assign({}, testProps)));
    ...
    it('renderOption should generate the right template', function () {
    });
    it('async fetchSuggestions should works fine', function () {
    });
});

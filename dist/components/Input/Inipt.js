...
export var Input = function (props) {
    ...
    var classes = classNames('setsail-input-wrapper', (_a = {},
    ...
    return (React.createElement("div", { className: classes, style: style },
        ...
        React.createElement("input", __assign({ className: 'setsail-input-inner', disabled: disabled }, restProps)),
        append && React.createElement("div", { className: 'setsail-input-group-append' }, append)));
};

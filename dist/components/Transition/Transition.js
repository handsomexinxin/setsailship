...
export var Transition = function (props) {
    ...
    return (React.createElement(CSSTransition, __assign({}, restProps, { classNames: classNames ? classNames : animation }), wrapper ? React.createElement("div", null, children) : children));
};
